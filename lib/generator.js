...
exports.default = {
  chineseGenerator: function chineseGenerator() {
    return wrapper.apply(undefined, [function () {
      return Array.apply(null, Array(randomRange(2, 8 + Math.pow(100, Number(this))))).map(function (i) {
  ...
  phoneGenerator: function phoneGenerator() {
    return wrapper.apply(undefined, [function () {
      return "1" + Array.apply(null, Array(randomRange(10, 10))).map(function (i) {
  ...
  lettersGenerator: function lettersGenerator() {
    return wrapper.apply(undefined, [function () {
      return Array.apply(null, Array(randomRange(10, 20 + Math.pow(100, Number(this))))).map(function (i) {
        return String.fromCharCode(randomRange(65, 122));
      }).join("") + Array.apply(null, Array(randomRange(0, 3))).map(function (i) {
